...
/**
 * MappingStatusesBYSearch represents the model behind the search form about `common\models\MappingStatusesBY`.
 */
class MappingStatusesBYSearch extends MappingStatusesBY
{
    /**
     * @inheritdoc
     */
