...
<div class="mapping-country-id-dvad-index">
    ...
    <div class="panel panel-default">
        <ul class="list-group">
            <li class="list-group-item">
                <span class="badge"><?= $offer_count_2k ?></span>
                Офферы
            </li>
        </ul>
                        ...
                        'buttons' => [
                            ...
                            'delete-offer' => function ($url, $modelOffers) {
                                $options = [
                                    ...
                                    'data-confirm' => Yii::t('yii', 'Вы уверены что хотите удалить ('.$modelOffers->product_name.') ?'),
                                    'data-method' => 'post',
                                    'data-pjax' => '0',
                                ];
                            ...
                            'redelete-offer' => function ($url, $modelOffers) {
                                $options = [
                                    'title' => Yii::t('yii', 'Удалить'),
                                    'aria-label' => Yii::t('yii', 'Удалить'),
                                    'data-confirm' => Yii::t('yii', 'Вы уверены что хотите восстановить ('.$modelOffers->product_name.') ?'),
                                    'data-method' => 'post',
                                    'data-pjax' => '0',
                                ];
    ...
    <div class="panel panel-default">
        <ul class="list-group">
            <li class="list-group-item">
                <span class="badge"><?= $statuses_count_2k ?></span>
                Статусы
            </li>
        </ul>
        <div class="panel-footer panel-callcenter">
